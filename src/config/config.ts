...
export const TARGET_WIDTH: number = 850;
export const TARGET_HEIGHT: number = 850;
export const MAX_IMAGE_SIZE: number = 2000;
export const MAX_CANVAS_SIZE: number = 2000;
